...
public class RandomPasswordGeneratorFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        copyButton = view.findViewById(R.id.btn_copy_password);
        regenerateButton = view.findViewById(R.id.btn_regenerate_password);
        ...
        regenerateButton.setOnClickListener(v -> generate());
    ...
    private void updatePasswordView() {
        ...
        toggleButton.setImageResource(visible ? R.drawable.ic_visibility_24 : R.drawable.ic_visibility_off_24);
        toggleButton.setContentDescription(getString(visible ? R.string.credential_hide_password_desc : R.string.credential_show_password_desc));
        copyButton.setImageResource(R.drawable.ic_content_copy_24);
        copyButton.setContentDescription(getString(R.string.copy));
        regenerateButton.setImageResource(R.drawable.ic_refresh_24);
        regenerateButton.setContentDescription(getString(R.string.regenerate));
